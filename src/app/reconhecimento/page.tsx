...
const badges = [
    { id: "excellence", label: "🌟 Excelência", color: "#6B7280", bg: "rgba(107,114,128,0.1)" },
    { id: "hero", label: "⚡ Super Herói", color: "#4B5563", bg: "rgba(75,85,99,0.1)" },
    { id: "top", label: "🏆 Top Performer", color: "#6B7280", bg: "rgba(107,114,128,0.1)" },
    { id: "heart", label: "❤️ Coração de Ouro", color: "#6B7280", bg: "rgba(107,114,128,0.1)" },
    { id: "innovation", label: "💡 Inovador", color: "#111827", bg: "rgba(17,24,39,0.1)" },
    { id: "team", label: "🤝 Espírito de Equipa", color: "#4B5563", bg: "rgba(75,85,99,0.1)" },
];
                                ...
                                <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 14 }}>
                                    ...
                                    <div style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center" }}>
                                        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                                            ...
                                            <Heart size={20} color="#6B7280" fill="#6B7280" />
                                            <div style={{ height: 1, width: 30, background: "#E2E8F0" }} />
                                        </div>
                                    </div>
                                    ...
                                    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 4 }}>
                                        <img src={rec.to.avatar} alt={rec.to.name}
                                            style={{ width: 44, height: 44, borderRadius: "50%", border: "3px solid #6B7280" }}
                                        />
                            ...
                            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                                {topRecognized.map((user, i) => (
                                    <div key={user.id} style={{
                                        ...
                                        padding: "8px 10px",
                                        borderRadius: 10,
                                        background: i === 0 ? "rgba(107,114,128,0.06)" : "transparent",
                                    }}>
